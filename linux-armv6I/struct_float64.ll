...
define dso_local %struct.struct1 @demo1(%struct.struct1 %0) #0 {
  ...
  store %struct.struct1 %0, %struct.struct1* %3, align 8
  ...
  %6 = load %struct.struct1, %struct.struct1* %2, align 8
...
define dso_local %struct.struct2 @demo2(%struct.struct2 %0) #0 {
  ...
  store %struct.struct2 %0, %struct.struct2* %3, align 8
  ...
  %6 = load %struct.struct2, %struct.struct2* %2, align 8
...
define dso_local %struct.struct3 @demo3(%struct.struct3 %0) #0 {
  ...
  store %struct.struct3 %0, %struct.struct3* %3, align 8
  ...
  %6 = load %struct.struct3, %struct.struct3* %2, align 8
...
define dso_local %struct.struct4 @demo4(%struct.struct4 %0) #0 {
  ...
  store %struct.struct4 %0, %struct.struct4* %3, align 8
  ...
  %6 = load %struct.struct4, %struct.struct4* %2, align 8
