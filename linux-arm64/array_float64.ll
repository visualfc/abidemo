...
define dso_local double @basic(double noundef %0) #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.array1 @demo1([1 x double] %0) #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.array2 @demo2([2 x double] %0) #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.array3 @demo3([3 x double] %0) #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.array4 @demo4([4 x double] %0) #0 {
