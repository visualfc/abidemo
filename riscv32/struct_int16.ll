...
define dso_local [2 x i32] @demo4([2 x i32] %0) #0 {
  ...
  %7 = bitcast %struct.struct4* %2 to [2 x i32]*
  %8 = load [2 x i32], [2 x i32]* %7, align 2
  ret [2 x i32] %8
}

; Function Attrs: noinline nounwind optnone
define dso_local void @demo5(%struct.struct5* noalias sret(%struct.struct5) align 2 %0, %struct.struct5* noundef %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone
define dso_local void @demo6(%struct.struct6* noalias sret(%struct.struct6) align 2 %0, %struct.struct6* noundef %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone
define dso_local void @demo7(%struct.struct7* noalias sret(%struct.struct7) align 2 %0, %struct.struct7* noundef %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone
define dso_local void @demo8(%struct.struct8* noalias sret(%struct.struct8) align 2 %0, %struct.struct8* noundef %1) #0 {
  %3 = alloca i8*, align 4
