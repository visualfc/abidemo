...
define dso_local void @demo1(%struct.struct1* noalias sret(%struct.struct1) align 2 %0, %struct.struct1* noundef byval(%struct.struct1) align 4 %1) #0 {
  %3 = alloca i8*, align 4
  %4 = bitcast %struct.struct1* %0 to i8*
  store i8* %4, i8** %3, align 4
  %5 = bitcast %struct.struct1* %0 to i8*
  %6 = bitcast %struct.struct1* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %5, i8* align 4 %6, i32 2, i1 false)
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo2(%struct.struct2* noalias sret(%struct.struct2) align 2 %0, %struct.struct2* noundef byval(%struct.struct2) align 4 %1) #0 {
  %3 = alloca i8*, align 4
  %4 = bitcast %struct.struct2* %0 to i8*
  store i8* %4, i8** %3, align 4
  %5 = bitcast %struct.struct2* %0 to i8*
  %6 = bitcast %struct.struct2* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %5, i8* align 4 %6, i32 4, i1 false)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo3(%struct.struct3* noalias sret(%struct.struct3) align 2 %0, %struct.struct3* noundef byval(%struct.struct3) align 4 %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo4(%struct.struct4* noalias sret(%struct.struct4) align 2 %0, %struct.struct4* noundef byval(%struct.struct4) align 4 %1) #0 {
  %3 = alloca i8*, align 4
  %4 = bitcast %struct.struct4* %0 to i8*
  store i8* %4, i8** %3, align 4
  %5 = bitcast %struct.struct4* %0 to i8*
  %6 = bitcast %struct.struct4* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %5, i8* align 4 %6, i32 8, i1 false)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo5(%struct.struct5* noalias sret(%struct.struct5) align 2 %0, %struct.struct5* noundef byval(%struct.struct5) align 4 %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo6(%struct.struct6* noalias sret(%struct.struct6) align 2 %0, %struct.struct6* noundef byval(%struct.struct6) align 4 %1) #0 {
  %3 = alloca i8*, align 4
  %4 = bitcast %struct.struct6* %0 to i8*
  store i8* %4, i8** %3, align 4
  %5 = bitcast %struct.struct6* %0 to i8*
  %6 = bitcast %struct.struct6* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %5, i8* align 4 %6, i32 12, i1 false)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo7(%struct.struct7* noalias sret(%struct.struct7) align 2 %0, %struct.struct7* noundef byval(%struct.struct7) align 4 %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo8(%struct.struct8* noalias sret(%struct.struct8) align 2 %0, %struct.struct8* noundef byval(%struct.struct8) align 4 %1) #0 {
  %3 = alloca i8*, align 4
  %4 = bitcast %struct.struct8* %0 to i8*
  store i8* %4, i8** %3, align 4
  %5 = bitcast %struct.struct8* %0 to i8*
  %6 = bitcast %struct.struct8* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %5, i8* align 4 %6, i32 16, i1 false)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo9(%struct.struct9* noalias sret(%struct.struct9) align 2 %0, %struct.struct9* noundef byval(%struct.struct9) align 4 %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo10(%struct.struct10* noalias sret(%struct.struct10) align 2 %0, %struct.struct10* noundef byval(%struct.struct10) align 4 %1) #0 {
  %3 = alloca i8*, align 4
  %4 = bitcast %struct.struct10* %0 to i8*
  store i8* %4, i8** %3, align 4
  %5 = bitcast %struct.struct10* %0 to i8*
  %6 = bitcast %struct.struct10* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %5, i8* align 4 %6, i32 20, i1 false)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo11(%struct.struct11* noalias sret(%struct.struct11) align 2 %0, %struct.struct11* noundef byval(%struct.struct11) align 4 %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo12(%struct.struct12* noalias sret(%struct.struct12) align 2 %0, %struct.struct12* noundef byval(%struct.struct12) align 4 %1) #0 {
  %3 = alloca i8*, align 4
  %4 = bitcast %struct.struct12* %0 to i8*
  store i8* %4, i8** %3, align 4
  %5 = bitcast %struct.struct12* %0 to i8*
  %6 = bitcast %struct.struct12* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %5, i8* align 4 %6, i32 24, i1 false)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo13(%struct.struct13* noalias sret(%struct.struct13) align 2 %0, %struct.struct13* noundef byval(%struct.struct13) align 4 %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo14(%struct.struct14* noalias sret(%struct.struct14) align 2 %0, %struct.struct14* noundef byval(%struct.struct14) align 4 %1) #0 {
  %3 = alloca i8*, align 4
  %4 = bitcast %struct.struct14* %0 to i8*
  store i8* %4, i8** %3, align 4
  %5 = bitcast %struct.struct14* %0 to i8*
  %6 = bitcast %struct.struct14* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %5, i8* align 4 %6, i32 28, i1 false)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo15(%struct.struct15* noalias sret(%struct.struct15) align 2 %0, %struct.struct15* noundef byval(%struct.struct15) align 4 %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo16(%struct.struct16* noalias sret(%struct.struct16) align 2 %0, %struct.struct16* noundef byval(%struct.struct16) align 4 %1) #0 {
  %3 = alloca i8*, align 4
  %4 = bitcast %struct.struct16* %0 to i8*
  store i8* %4, i8** %3, align 4
  %5 = bitcast %struct.struct16* %0 to i8*
  %6 = bitcast %struct.struct16* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %5, i8* align 4 %6, i32 32, i1 false)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo17(%struct.struct17* noalias sret(%struct.struct17) align 2 %0, %struct.struct17* noundef byval(%struct.struct17) align 4 %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo18(%struct.struct18* noalias sret(%struct.struct18) align 2 %0, %struct.struct18* noundef byval(%struct.struct18) align 4 %1) #0 {
  %3 = alloca i8*, align 4
  %4 = bitcast %struct.struct18* %0 to i8*
  store i8* %4, i8** %3, align 4
  %5 = bitcast %struct.struct18* %0 to i8*
  %6 = bitcast %struct.struct18* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %5, i8* align 4 %6, i32 36, i1 false)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo19(%struct.struct19* noalias sret(%struct.struct19) align 2 %0, %struct.struct19* noundef byval(%struct.struct19) align 4 %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo20(%struct.struct20* noalias sret(%struct.struct20) align 2 %0, %struct.struct20* noundef byval(%struct.struct20) align 4 %1) #0 {
  %3 = alloca i8*, align 4
  %4 = bitcast %struct.struct20* %0 to i8*
  store i8* %4, i8** %3, align 4
  %5 = bitcast %struct.struct20* %0 to i8*
  %6 = bitcast %struct.struct20* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %5, i8* align 4 %6, i32 40, i1 false)
  ret void
}
