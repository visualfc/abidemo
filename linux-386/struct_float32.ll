...
define dso_local void @demo1(%struct.struct1* noalias sret(%struct.struct1) align 4 %0, float %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo2(%struct.struct2* noalias sret(%struct.struct2) align 4 %0, float %1, float %2) #0 {
  %4 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo3(%struct.struct3* noalias sret(%struct.struct3) align 4 %0, float %1, float %2, float %3) #0 {
  %5 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo4(%struct.struct4* noalias sret(%struct.struct4) align 4 %0, float %1, float %2, float %3, float %4) #0 {
  %6 = alloca i8*, align 4
