...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define %struct.array1 @demo1([1 x double] %0) #0 {
  ...
  store [1 x double] %0, [1 x double]* %4, align 8
  %5 = bitcast %struct.array1* %2 to i8*
  %6 = bitcast %struct.array1* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %5, i8* align 8 %6, i64 8, i1 false)
  %7 = load %struct.array1, %struct.array1* %2, align 8
  ret %struct.array1 %7
}
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define %struct.array2 @demo2([2 x double] %0) #0 {
  ...
  %7 = load %struct.array2, %struct.array2* %2, align 8
  ret %struct.array2 %7
}

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define %struct.array3 @demo3([3 x double] %0) #0 {
  ...
  %7 = load %struct.array3, %struct.array3* %2, align 8
  ret %struct.array3 %7
}

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define %struct.array4 @demo4([4 x double] %0) #0 {
  ...
  %7 = load %struct.array4, %struct.array4* %2, align 8
  ret %struct.array4 %7
}

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo5(%struct.array5* noalias sret(%struct.array5) align 8 %0, %struct.array5* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo6(%struct.array6* noalias sret(%struct.array6) align 8 %0, %struct.array6* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo7(%struct.array7* noalias sret(%struct.array7) align 8 %0, %struct.array7* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo8(%struct.array8* noalias sret(%struct.array8) align 8 %0, %struct.array8* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo9(%struct.array9* noalias sret(%struct.array9) align 8 %0, %struct.array9* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo10(%struct.array10* noalias sret(%struct.array10) align 8 %0, %struct.array10* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo11(%struct.array11* noalias sret(%struct.array11) align 8 %0, %struct.array11* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo12(%struct.array12* noalias sret(%struct.array12) align 8 %0, %struct.array12* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo13(%struct.array13* noalias sret(%struct.array13) align 8 %0, %struct.array13* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo14(%struct.array14* noalias sret(%struct.array14) align 8 %0, %struct.array14* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo15(%struct.array15* noalias sret(%struct.array15) align 8 %0, %struct.array15* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo16(%struct.array16* noalias sret(%struct.array16) align 8 %0, %struct.array16* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo17(%struct.array17* noalias sret(%struct.array17) align 8 %0, %struct.array17* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo18(%struct.array18* noalias sret(%struct.array18) align 8 %0, %struct.array18* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo19(%struct.array19* noalias sret(%struct.array19) align 8 %0, %struct.array19* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo20(%struct.array20* noalias sret(%struct.array20) align 8 %0, %struct.array20* noundef %1) #0 {
