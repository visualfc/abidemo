...
define %struct.struct1 @demo1([1 x double] %0) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define %struct.struct2 @demo2([2 x double] %0) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define %struct.struct3 @demo3([3 x double] %0) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define %struct.struct4 @demo4([4 x double] %0) #0 {
