...
define i32 @demo1(i64 %0) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %6, i8* align 8 %7, i64 4, i1 false)
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define [2 x i64] @demo3([2 x i64] %0) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define [2 x i64] @demo4([2 x i64] %0) #0 {
