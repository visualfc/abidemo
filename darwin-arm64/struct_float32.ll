...
define %struct.struct1 @demo1([1 x float] %0) #0 {
  ...
  %8 = load %struct.struct1, %struct.struct1* %2, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define %struct.struct2 @demo2([2 x float] %0) #0 {
  ...
  %7 = load %struct.struct2, %struct.struct2* %2, align 4
  ret %struct.struct2 %7
}

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define %struct.struct3 @demo3([3 x float] %0) #0 {
  %2 = alloca %struct.struct3, align 4
  %3 = alloca %struct.struct3, align 4
  %4 = bitcast %struct.struct3* %3 to [3 x float]*
  ...
  %7 = load %struct.struct3, %struct.struct3* %2, align 4
  ret %struct.struct3 %7
}

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define %struct.struct4 @demo4([4 x float] %0) #0 {
  %2 = alloca %struct.struct4, align 4
  %3 = alloca %struct.struct4, align 4
  %4 = bitcast %struct.struct4* %3 to [4 x float]*
  ...
  %7 = load %struct.struct4, %struct.struct4* %2, align 4
  ret %struct.struct4 %7
}

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo5(%struct.struct5* noalias sret(%struct.struct5) align 4 %0, %struct.struct5* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo6(%struct.struct6* noalias sret(%struct.struct6) align 4 %0, %struct.struct6* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo7(%struct.struct7* noalias sret(%struct.struct7) align 4 %0, %struct.struct7* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo8(%struct.struct8* noalias sret(%struct.struct8) align 4 %0, %struct.struct8* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo9(%struct.struct9* noalias sret(%struct.struct9) align 4 %0, %struct.struct9* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo10(%struct.struct10* noalias sret(%struct.struct10) align 4 %0, %struct.struct10* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo11(%struct.struct11* noalias sret(%struct.struct11) align 4 %0, %struct.struct11* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo12(%struct.struct12* noalias sret(%struct.struct12) align 4 %0, %struct.struct12* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo13(%struct.struct13* noalias sret(%struct.struct13) align 4 %0, %struct.struct13* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo14(%struct.struct14* noalias sret(%struct.struct14) align 4 %0, %struct.struct14* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo15(%struct.struct15* noalias sret(%struct.struct15) align 4 %0, %struct.struct15* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo16(%struct.struct16* noalias sret(%struct.struct16) align 4 %0, %struct.struct16* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo17(%struct.struct17* noalias sret(%struct.struct17) align 4 %0, %struct.struct17* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo18(%struct.struct18* noalias sret(%struct.struct18) align 4 %0, %struct.struct18* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo19(%struct.struct19* noalias sret(%struct.struct19) align 4 %0, %struct.struct19* noundef %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @demo20(%struct.struct20* noalias sret(%struct.struct20) align 4 %0, %struct.struct20* noundef %1) #0 {
