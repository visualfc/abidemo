...
define dso_local i64 @demo1(i64 %0) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 2 %7, i8* align 8 %8, i64 2, i1 false)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %12, i8* align 2 %13, i64 2, i1 false)
...
define dso_local i64 @demo2(i64 %0) #0 {
  ...
  %8 = bitcast i64* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 2 %7, i8* align 8 %8, i64 4, i1 false)
  %9 = bitcast %struct.array2* %2 to i8*
  %10 = bitcast %struct.array2* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 2 %9, i8* align 2 %10, i64 4, i1 false)
  %11 = getelementptr inbounds %struct.array2, %struct.array2* %2, i32 0, i32 0
  %12 = bitcast i64* %5 to i8*
  %13 = bitcast [2 x i16]* %11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %12, i8* align 2 %13, i64 4, i1 false)
  %14 = load i64, i64* %5, align 8
  ret i64 %14
}
