...
; Function Attrs: noinline nounwind optnone
define dso_local void @demo3(%struct.struct3* noalias sret(%struct.struct3) align 8 %0, %struct.struct3* noundef %1) #0 {
  %3 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone
define dso_local void @demo4(%struct.struct4* noalias sret(%struct.struct4) align 8 %0, %struct.struct4* noundef %1) #0 {
  %3 = alloca i8*, align 8
...
define dso_local void @demo11(%struct.struct11* noalias sret(%struct.struct11) align 8 %0, %struct.struct11* noundef %1) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %5, i8* align 8 %6, i64 88, i1 false)
  ret void
}
...
define dso_local void @demo14(%struct.struct14* noalias sret(%struct.struct14) align 8 %0, %struct.struct14* noundef %1) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %5, i8* align 8 %6, i64 112, i1 false)
  ret void
}
...
define dso_local void @demo17(%struct.struct17* noalias sret(%struct.struct17) align 8 %0, %struct.struct17* noundef %1) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %5, i8* align 8 %6, i64 136, i1 false)
  ret void
}
...
define dso_local void @demo18(%struct.struct18* noalias sret(%struct.struct18) align 8 %0, %struct.struct18* noundef %1) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %5, i8* align 8 %6, i64 144, i1 false)
  ret void
}
...
define dso_local void @demo20(%struct.struct20* noalias sret(%struct.struct20) align 8 %0, %struct.struct20* noundef %1) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %5, i8* align 8 %6, i64 160, i1 false)
  ret void
}
