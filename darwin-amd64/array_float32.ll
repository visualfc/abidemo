; ModuleID = '../data/array_float32.c'
source_filename = "../data/array_float32.c"
...
define float @demo1(float %0) #0 {
  ...
  %5 = bitcast [1 x float]* %4 to float*
  ...
  %9 = bitcast [1 x float]* %8 to float*
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define <2 x float> @demo2(<2 x float> %0) #2 {
  ...
  %5 = bitcast [2 x float]* %4 to <2 x float>*
  ...
  %9 = bitcast [2 x float]* %8 to <2 x float>*
  %10 = load <2 x float>, <2 x float>* %9, align 4
  ret <2 x float> %10
}

; Function Attrs: noinline nounwind optnone ssp uwtable
define { <2 x float>, float } @demo3(<2 x float> %0, float %1) #2 {
  ...
  %14 = bitcast { <2 x float>, float }* %6 to i8*
  %15 = bitcast [3 x float]* %13 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %14, i8* align 4 %15, i64 12, i1 false)
  %16 = load { <2 x float>, float }, { <2 x float>, float }* %6, align 8
  ret { <2 x float>, float } %16
}

; Function Attrs: noinline nounwind optnone ssp uwtable
define { <2 x float>, <2 x float> } @demo4(<2 x float> %0, <2 x float> %1) #2 {
  %3 = alloca %struct.array4, align 4
  %4 = alloca %struct.array4, align 4
  %5 = bitcast %struct.array4* %4 to { <2 x float>, <2 x float> }*
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo5(%struct.array5* noalias sret(%struct.array5) align 4 %0, %struct.array5* noundef byval(%struct.array5) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo6(%struct.array6* noalias sret(%struct.array6) align 4 %0, %struct.array6* noundef byval(%struct.array6) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo7(%struct.array7* noalias sret(%struct.array7) align 4 %0, %struct.array7* noundef byval(%struct.array7) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo8(%struct.array8* noalias sret(%struct.array8) align 4 %0, %struct.array8* noundef byval(%struct.array8) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo9(%struct.array9* noalias sret(%struct.array9) align 4 %0, %struct.array9* noundef byval(%struct.array9) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo10(%struct.array10* noalias sret(%struct.array10) align 4 %0, %struct.array10* noundef byval(%struct.array10) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo11(%struct.array11* noalias sret(%struct.array11) align 4 %0, %struct.array11* noundef byval(%struct.array11) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo12(%struct.array12* noalias sret(%struct.array12) align 4 %0, %struct.array12* noundef byval(%struct.array12) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo13(%struct.array13* noalias sret(%struct.array13) align 4 %0, %struct.array13* noundef byval(%struct.array13) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo14(%struct.array14* noalias sret(%struct.array14) align 4 %0, %struct.array14* noundef byval(%struct.array14) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo15(%struct.array15* noalias sret(%struct.array15) align 4 %0, %struct.array15* noundef byval(%struct.array15) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo16(%struct.array16* noalias sret(%struct.array16) align 4 %0, %struct.array16* noundef byval(%struct.array16) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo17(%struct.array17* noalias sret(%struct.array17) align 4 %0, %struct.array17* noundef byval(%struct.array17) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo18(%struct.array18* noalias sret(%struct.array18) align 4 %0, %struct.array18* noundef byval(%struct.array18) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo19(%struct.array19* noalias sret(%struct.array19) align 4 %0, %struct.array19* noundef byval(%struct.array19) align 8 %1) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @demo20(%struct.array20* noalias sret(%struct.array20) align 4 %0, %struct.array20* noundef byval(%struct.array20) align 8 %1) #0 {
...
attributes #2 = { noinline nounwind optnone ssp uwtable "darwin-stkchk-strong-link" "frame-pointer"="all" "min-legal-vector-width"="64" "no-trapping-math"="true" "probe-stack"="___chkstk_darwin" "stack-protector-buffer-size"="8" "target-cpu"="penryn" "target-features"="+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87" "tune-cpu"="generic" }
